    ...
    <div className="flex projectsDiv">
      ...
      <div className="column project">
        ...
        <div className="infoProject column">
          ...
          <a
            href="https://github.com/silvanarl/LIM012-data-lovers/src/"
            target="_blank"
            rel="noreferrer"
          >
            <button className="buttonDemo" type="button">Demo</button>
          ...
          <a
            href="https://silvanarl.github.io/LIM012-data-lovers/"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <div className="column project">
        ...
        <div className="infoProject column">
          ...
          <a
            href="https://github.com/silvanarl/LIM012-fe-social-network/src/"
            target="_blank"
            rel="noreferrer"
          >
            <button className="buttonDemo" type="button">Demo</button>
          ...
          <a
            href="https://silvanarl.github.io/LIM012-fe-social-network/"
            target="_blank"
            rel="noreferrer"
          >
            <button className="buttonDemo" type="button">Repo</button>
